...
- [[First principles are the simplest something can be, but not simpler\|First principles are the simplest something can be, but not simpler]]

[^1]: Attributed to Einstein, see [[First principles are the simplest something can be, but not simpler\|First principles are the simplest something can be, but not simpler]] footnote 1.
